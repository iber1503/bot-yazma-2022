...
#Kullanıcıdan "kullanıcı adı" ve "şifre" bilgilerini alalım ve veritabanını temsil eden değişkenler
#içindeki veri ile eşitliğini kontrol edelim
"""
k_kadi  =  input("Kullanıcı adınızı girin:")
k_sifre = input("Şifrenizi Girin")
print(f"Kullanıcı adı doğru mu: {kullanici_adi == k_kadi}")
print(f"Şifre doğru mu: {sifre==k_sifre}")
"""
 #Kullanıcıdan iki sayı alalım.Birbirine "eşit değil mi?" kontrolü yapalım.
